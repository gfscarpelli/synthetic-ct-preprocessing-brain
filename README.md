...
Sample comparisons between reference CT and generated sCT across axial, coronal, and sagittal planes are available in the [`results/sample/`](results/sample/) folder.
